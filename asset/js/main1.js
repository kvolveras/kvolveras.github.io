...
function scrollFunction() {
  ...
  if ($("body,html").scrollTop() > 100) {
    ...
    $(".row_header3").css("box-shadow","0 10px 10px rgba(.05,0,0,0.05)");
...
function openCity(evt, cityName) {
  ...
  function initMap() {
        ...
        var myLatLng = {lat: 3.464972, lng: -76.529472 };
        var map = new google.maps.Map(document.getElementById('googlemap1'), {
            center: { lat: 3.464972, lng: -76.529472 },
            zoom: 16.25,
            styles: [
    {
        "featureType": "all",
